...
//                                if(len == 1){
//
//                                    usb_leds.data[0] = pEP0_DataBuf[0];
//                                    usboutflag = 1;
//                                    LOG_INFO("set leds :%#x", usb_leds.data[0]);
//
//                                    rf_port_load_data_irq(RF_TYPE_REQ_KEY, (uint8_t *)&usb_leds,
//                                                          sizeof(usb_leds) - sizeof(usb_leds.data) + 1);
//                                }
                            }
                        }
                        if( USBFS_SetupReqLen == 0 )
...
//            if(atomic_test_bit(usb_pm_;;flag, USB_FEATURE_FLAG))
//            {
//                LOG_INFO("USB host sleep\n");
//                rf_data_t usb_leds ={0};
//                usb_leds.data[0] = 0x08;
//                rf_port_load_data_;;irq(RF_TYPE_REQ_KEY, (uint8_t *)&usb_leds,
//                                      sizeof(usb_leds) - sizeof(usb_leds.data) + 1);
//                rf_sync_stop();
//            }
